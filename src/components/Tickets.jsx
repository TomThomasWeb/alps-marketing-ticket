      ...
      <div className="hub-filter-bar" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16, flexWrap: "wrap", gap: 10 }}>
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          <div style={{ display: "flex", gap: 2, background: "var(--bg-card)", borderRadius: 6, padding: 2, border: "1px solid var(--border)" }}>
            ...
            <button onClick={() => setViewMode("queue")} title="Queue view" style={{ padding: "5px 8px", borderRadius: 4, border: "none", cursor: "pointer", background: viewMode === "queue" ? "var(--brand)" : "transparent", color: viewMode === "queue" ? "\#fff" : "var(--text-muted)", fontSize: 12, transition: "all 0.15s" }}>{1F4CB}</button>
